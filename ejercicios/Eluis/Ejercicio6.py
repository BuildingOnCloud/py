...
# 1. a un usuario registrar temperaturas y sus fechas
# para luego calcular estadísticas:
# 2. como el promedio, 
# 3. la temperatura máxima 
# 4. temperatura  mínima.
#Utilice un diccionario para almacenar las temperaturas
#fechas registradas por el usuario.
#Utilice una tupla para almacenar los calculos redizados.
    ...
    try:
        ...
        if opcion == 1:
           Registrar_temperaturas ()
            ...
            print("\nOpción no válida. Por favor, elija un nuemro dentro del menu.")
