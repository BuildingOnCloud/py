...
#El programa debe solicitar al usuario que ingrese dos números y luego seleccionar la operación que desea realizar. Después, debe mostrar el resultado de la operación.
